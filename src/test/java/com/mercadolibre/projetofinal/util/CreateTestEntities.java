...
public class CreateTestEntities {
    ...
    public static final AccountCreatedResponseDTO accountCreatedResponseDTO = createAccountCreatedResponseDTO();
    ...
    public static final AccountRequestDTO accountRequestDTO = createAccountRequestDto();
    ...
    public static AccountRequestDTO createAccountRequestDto(){
        return new AccountRequestDTO("id1", "username1", "COSTA_RICA", "BUYER","warehouse1");
    }
    ...
    public static AccountCreatedResponseDTO createAccountCreatedResponseDTO(){
        return new AccountCreatedResponseDTO("id1", "username1", "warehouse1", "BRAZIL");
    }
}
