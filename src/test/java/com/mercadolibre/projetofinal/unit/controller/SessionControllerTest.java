...
class SessionControllerTest {
    ...
    void loginFail() throws Exception {
        assertThrows(ApiException.class, () -> controller.login(new LoginRequestDTO("user_one","contra12")),
                "Usuario y/o contraseña incorrecto");
    }

    @Test
    void loginOk() throws Exception {
        AccountResponseDTO accountResponseDTO = controller.login(new LoginRequestDTO("user_one","contra123"));
        assertEquals("user_one", accountResponseDTO.getUsername());
