...
public class WarehouseService implements IWarehouseService {
    ...
    @Override
    public WarehouseDTO findByIdDTO(String id) {
        Optional<Warehouse> opt = warehouseRepository.findById(id);
    ...
    @Override
    public Warehouse findById(String id){return warehouseRepository.findById(id).orElseThrow(() -> new NotFoundException(ML200));}
