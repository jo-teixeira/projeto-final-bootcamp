...
public class PurchaseOrderService implements IPurchaseOrderService {
    ...
    public PurchaseValueResponseDTO create(PurchaseRequestDTO purchaseRequestDTO, String token) {
        ...
        return createPurchaseOrder(purchaseRequestDTO, account, products);
    }
    ...
    private PurchaseValueResponseDTO createPurchaseOrder(PurchaseRequestDTO purchaseRequestDTO, AccountDTO accountDTO,
        ...
        return new PurchaseValueResponseDTO(newPurchaseOrder.getId(), totalPriceCalculated);
    }
