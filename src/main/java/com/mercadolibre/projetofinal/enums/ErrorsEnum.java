...
public enum ErrorsEnum {
    ...
    ML802("ML-802", "This username already exists", HttpStatus.CONFLICT),
    ML803("ML-803", "Invalid role", HttpStatus.BAD_REQUEST),
    ML804("ML-804", "Invalid country", HttpStatus.BAD_REQUEST),
    ML805("ML-805", "User country and warehouse country must be equals", HttpStatus.BAD_REQUEST),
