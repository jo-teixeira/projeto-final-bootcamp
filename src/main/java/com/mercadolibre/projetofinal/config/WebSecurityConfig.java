...
import static com.mercadolibre.projetofinal.enums.AccountRolesEnum.ADMIN;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST,"/api/v1/admin/user").hasRole(ADMIN.getRole())
                .antMatchers(HttpMethod.GET,"/api/v1/admin/user").hasRole(ADMIN.getRole())
