...
public class PopulateDatabase {
    ...
    public void populate(){
        ...
        LocalDate date = LocalDate.now();
        LocalDateTime dateTime = LocalDateTime.now();
        String bcriptPassword = BCrypt.hashpw("contSD#&#!SD3", BCrypt.gensalt(10));
        ...
        List<Account> accounts = new ArrayList(List.of(
                new Account(null,"user_one",CountryEnum.BRAZIL, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(0), new HashSet<>()),
                new Account(null,"user_two",CountryEnum.BOLIVIA, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(1), new HashSet<>()),
                new Account(null,"user_three",CountryEnum.ARGENTINA, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(2), new HashSet<>()),
                new Account(null,"user_four",CountryEnum.CHILE, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(3), new HashSet<>()),
                new Account(null,"user_five",CountryEnum.COLOMBIA, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(3), new HashSet<>()),

                // argentina
                new Account(null,"user_argentina_representative",CountryEnum.ARGENTINA, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(4), new HashSet<>()),
                new Account(null,"user_argentina_buyer",CountryEnum.ARGENTINA, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(4), new HashSet<>()),

                // chile
                new Account(null,"user_chile_representative",CountryEnum.CHILE, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(4), new HashSet<>()),
                new Account(null,"user_chile_buyer",CountryEnum.CHILE, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(4), new HashSet<>()),

                // uruguay
                new Account(null,"user_uruguay_representative",CountryEnum.URUGUAY, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(4), new HashSet<>()),
                new Account(null,"user_uruguay_buyer",CountryEnum.URUGUAY, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(4), new HashSet<>()),

                // colombia
                new Account(null,"user_colombia_representative",CountryEnum.COLOMBIA, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(4), new HashSet<>()),
                new Account(null,"user_colombia_buyer",CountryEnum.COLOMBIA, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(4), new HashSet<>()),

                // brazil 1
                new Account(null,"user_brazil1_representative",CountryEnum.BRAZIL, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(4), new HashSet<>()),
                new Account(null,"user_brazil1_buyer",CountryEnum.BRAZIL, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(4), new HashSet<>()),

                // brazil 2
                new Account(null,"user_brazil2_representative",CountryEnum.BRAZIL, bcriptPassword,  AccountRolesEnum.REPRESENTATIVE,  warehouses.get(5), new HashSet<>()),
                new Account(null,"user_brazil2_buyer",CountryEnum.BRAZIL, bcriptPassword,  AccountRolesEnum.BUYER,  warehouses.get(5), new HashSet<>())
        ));
